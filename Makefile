...
builtins builtins/builtins_storage builtins/builtin_test builtins/builtins_aliases builtins/builtin_echo\
utils \
aliases)
...
CFILES += $(addprefix builtins/builtin_test/, builtin_test.c unary.c binary.c)
