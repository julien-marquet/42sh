...
#    Updated: 2019/04/26 04:16:51 by jmarquet    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
CFILES += $(addprefix editing/input/, input_search_mode.c input_selection.c input_control.c input_action_handlers.c input_bufs_utils.c input_call_history.c input_capabilities_dispatchers.c input_handlers.c input_main_process.c input_utils.c input_validator.c)
...
CFILES += $(addprefix builtins/, builtin_fc.c builtin_type.c builtin_cd.c builtins_utils.c builtin_exit.c builtins_dispatcher.c builtins_execution.c)
...
TMPFILES += $(addprefix editing/input/, input.h input_search_mode.h input_selection.h input_keycodes.h input_control.h input_action_handlers.h input_bufs_utils.h input_call_history.h input_capabilities_dispatchers.h input_handlers.h input_main_process.h input_utils.h input_validator.h)
...
TMPFILES += $(addprefix builtins/, builtin_fc.h builtin_type.h builtin_cd.h builtins_utils.h builtin_exit.h builtins_dispatcher.h builtins_execution.h builtins_defines.h builtins.h)
