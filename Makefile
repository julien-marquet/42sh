...
#    Updated: 2019/04/08 01:56:43 by jmarquet    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
CFILES += $(addprefix builtins/, builtin_test.c builtin_echo.c builtin_exit.c builtins_dispatcher.c builtins_execution.c)
...
TMPFILES += $(addprefix builtins/, builtin_test.h builtin_echo.h builtin_exit.h builtins_dispatcher.h builtins_execution.h builtins_defines.h builtins.h)
