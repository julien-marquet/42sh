...
#    Updated: 2019/04/30 10:02:56 by jmarquet    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
CFILES += $(addprefix builtins/, builtin_true.c builtin_false.c builtin_fc.c builtin_type.c builtin_cd.c builtins_utils.c builtin_exit.c builtins_dispatcher.c builtins_execution.c)
