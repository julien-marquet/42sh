...
#    Updated: 2019/04/07 23:32:13 by jmarquet    ###    #+. /#+    ###.fr      #
#                                                          /                   #
#                                                         /                    #
# **************************************************************************** #
...
CFILES += $(addprefix builtins/builtins_storage/, builtin_unset.c builtin_unsetenv.c builtin_set.c builtin_env.c builtin_setenv.c)
...
TMPFILES += $(addprefix builtins/builtins_storage/, builtin_unset.h builtin_unsetenv.h builtin_set.h builtin_env.h builtin_setenv.h builtins_storage.h)
