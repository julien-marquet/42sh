...
CFILES += $(addprefix builtins/, builtin_type.c builtin_cd.c builtins_utils.c builtin_exit.c builtins_dispatcher.c builtins_execution.c)
...
TMPFILES += $(addprefix builtins/, builtin_type.h builtin_cd.h builtins_utils.h builtin_exit.h builtins_dispatcher.h builtins_execution.h builtins_defines.h builtins.h)
