...
builtins builtins/builtins_storage builtins/builtin_test builtins/builtin_hash builtins/builtins_aliases builtins/builtin_echo\
utils \
aliases)
...
CFILES += $(addprefix builtins/builtin_hash/, builtin_hash.c table.c)
