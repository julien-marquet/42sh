...
/*   Updated: 2019/04/05 18:14:22 by jmarquet    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
int		print_anew(t_cur_abs_pos *start_pos,
		t_dyn_buf *active_buf, size_t rel_cur_pos);
int		insertn_chars(t_input_data *input_data,
		const char *str, size_t n, int force);
